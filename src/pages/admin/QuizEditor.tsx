            ...
            <div className="flex items-center gap-4 mt-2 border-t border-white/5 pt-4">
               <label className="flex items-center gap-2 text-sm text-white/60">
                 ...
                 <input 
                   ...
                   onChange={e => {
                      const newQs = [...questions];
                      newQs[index].active = e.target.checked;
                      setQuestions(newQs);
                   }}
                   className="rounded bg-white/5 border-white/20 text-emerald-500"
                 />
               </label>
               <label className="flex items-center gap-2 text-sm text-white/60">
                 Pontos: 
                 <input 
                   ...
                   className="w-20 bg-black/20 border border-white/10 rounded px-2 py-1 text-white"
                 />
               </label>
            </div>
          </div>
