          ...
          >
            <div className="relative w-10 h-10 flex-shrink-0 rounded-lg overflow-hidden bg-theme-card-bg">
              {track.coverUrl ? (
                <img 
                  src={track.coverUrl} 
                  alt={track.title} 
                  className={cn("w-full h-full object-cover", isCurrent && isPlaying ? "opacity-50" : "")} 
                />
              ) : (
            ...
            {isCurrent && isPlaying && (
              <div className="flex gap-0.5 h-4 items-end px-2">
                <div className="w-1 bg-theme-primary animate-pulse h-full" style={{ animationDelay: '0.1s' }} />
                <div className="w-1 bg-theme-primary animate-pulse h-2/3" style={{ animationDelay: '0.3s' }} />
                <div className="w-1 bg-theme-primary animate-pulse h-4/5" style={{ animationDelay: '0.2s' }} />
              </div>
            )}
          </button>
        );
